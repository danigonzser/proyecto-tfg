...
\begin{itemize}
    \item[\regular] Escalabilidad: el manejo de estados puede llegar a ser algo bastante complejo.
    \item[\bien] Mantenimiento: puede ser complicado en aplicaciones grandes.
