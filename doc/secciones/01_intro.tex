...
\section{Historias de usuario}
    ...
    \subsection{Cristina Contreras Márquez (estudiante de ingeniería informática)}
        ...
        \begin{enumerate}
            ...
            \item [HU02] Como Cristina Contreras Márquez, estudiante de Ingeniería Informática, quiero crear memes que posteriormente puedan ser modificados o reutilizados por otros usuarios.
        \end{enumerate}
    ...
    \subsection{Ted Johnson González (experto conferenciante)}
        ...
        \begin{enumerate}
            ...
            \item [HU04] Como Ted Johnson González, experto conferenciante, quiero modificar el meme que he encontrado para adaptarlo a mi presentación y estilo.
        \end{enumerate}
